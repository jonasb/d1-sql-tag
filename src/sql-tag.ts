import type { D1Database as D1Db, D1Response, D1Result } from "@cloudflare/workers-types";

// The types generated by `wrangler types` is not fully compatible with @cloudflare/workers-types
type D1Database = Omit<D1Db, "withSession">;
